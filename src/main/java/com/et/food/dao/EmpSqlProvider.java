...
public class EmpSqlProvider {
     ...
     *
     * @mbg.generated Tue Dec 12 20:20:24 CST 2017
     */
    ...
    public String insertSelective(Emp record) {
        ...
        if (record.getSal() != null) {
            sql.VALUES("sal", "#{sal,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getSal() != null) {
            sql.SET("sal = #{record.sal,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Emp record) {
        ...
        if (record.getSal() != null) {
            sql.SET("sal = #{sal,jdbcType=VARCHAR}");
        }
